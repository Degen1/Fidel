    ...
    <View style={styles.container}>
      ...
      <View style={styles.columns}>
        <View style={styles.column}>
          ...
          <Pressable style={[styles.button, styles.negativeButton]} onPress={() => changeStep(-10)}>
            <Text style={styles.buttonText}>-10</Text>
          </Pressable>

          <Pressable style={[styles.button, styles.negativeButton]} onPress={() => changeStep(-100)}>
        ...
        <View style={styles.column}>
          ...
          <Pressable style={styles.button} onPress={() => changeStep(10)}>
            <Text style={styles.buttonText}>+10</Text>
          </Pressable>
           <Pressable style={styles.button} onPress={() => changeStep(100)}>
            <Text style={styles.buttonText}>+100</Text>
          </Pressable>
        </View>
      </View>
