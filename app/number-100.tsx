...
export default function HundredsScreen() {
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.screenBg }]} {...panResponder.panHandlers}>
      <Text style={[styles.screenZero, { color: colors.mainText, top: insets.top + 8 }]}>00</Text>
      ...
      <View style={styles.mainArea}>
        <Text style={[styles.currentNumber, { color: colors.mainText }]}>{NUMBERS[activeIndex]}00</Text>
