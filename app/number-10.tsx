...
export default function TensScreen() {
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.screenBg }]} {...panResponder.panHandlers}>
      <Text style={[styles.screenZero, { color: colors.mainText, top: insets.top + 8 }]}>0</Text>
      ...
      <View style={styles.mainArea}>
        <Text style={[styles.currentNumber, { color: colors.mainText }]}>{NUMBERS[activeIndex]}0</Text>
