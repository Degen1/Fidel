      ...
      {isOpen && (
        <Modal transparent visible animationType="none" onRequestClose={closeDropdown}>
          ...
          <Pressable
            ...
            accessibilityLabel="ቋንቋ ምርጫ ዕጾ"
            onPress={closeDropdown}
            style={[
              styles.openDropdownTrigger,
              {
                top: dropdownFrame.y,
          ...
          <View style={styles.translatorContainer}>
              <View style={styles.languageBar}>
                <View style={styles.languageColumn}>
                  <Text style={[styles.fieldLabel, { color: palette.muted }]}>ካብ</Text>
                  <DropdownSearch
                    selectedValue={translatorFrom}
                    style={styles.translatorPicker}
                    itemStyle={{ color: palette.text, fontSize: 15, fontWeight: "700" }}
                  ...
                  >
                    {LANGUAGES.map((lang) => (
                      <DropdownSearch.Item key={lang.value} label={lang.label} value={lang.value} />
                    ))}
                  </DropdownSearch>
                </View>
                ...
                <TouchableOpacity
                  accessibilityRole="button"
                  accessibilityLabel="ቋንቋታት ቀያይር"
                  onPress={handleSwap}
                  activeOpacity={0.75}
                  style={[styles.swapButton, { backgroundColor: palette.button }]}
                >
                  <MaterialCommunityIcons name="swap-horizontal" size={22} color={palette.buttonText} />
                </TouchableOpacity>

                <View style={styles.languageColumn}>
                  <Text style={[styles.fieldLabel, { color: palette.muted }]}>ናብ</Text>
                  <DropdownSearch
              ...
              <View style={[styles.translationCard, { backgroundColor: palette.surfaceStrong, borderColor: palette.border }]}>
                <Text style={[styles.cardLabel, { color: palette.muted }]}>ጽሑፍ</Text>
              ...
              <View style={[styles.translationCard, { backgroundColor: palette.surfaceStrong, borderColor: palette.border }]}>
                <Text style={[styles.cardLabel, { color: palette.muted }]}>ትርጉም</Text>
                <TextInput
                style={[
                  styles.translatorInput,
                  {
